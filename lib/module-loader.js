...
module.exports = {
  ...
  load: function () {
    ...
    function loadServices (cb) {
      pcsapi.log.verbose(`module-loader.js - load - Loading services from ${process.cwd()}/api/services`)
...
function loadModulesFromPath (servicesPath, cb) {
  pcsapi.log.verbose(`module-loader.js - loadModulesFromPath - Loading services from ${servicesPath}`)
  includeAll.optional({
