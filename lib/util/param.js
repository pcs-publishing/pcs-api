...
module.exports = {
  ...
  getBooleanFromParam: function (req, paramName, required, error) {
    let param = getParam(req, paramName)
  ...
  getStringFromParam: function (req, paramName, required, error) {
    const param = getParam(req, paramName)

    if (
      hasValue(param) &&
        !_.isObject(param) &&
        _.isFunction(param.toString)
    ) {
  ...
  getIntArrayFromParam: function (req, paramName, required, error) {
    const arrayOfIntParams = _.map(
      getArrayFromParam(req, paramName, required, error),
      val => {
  ...
  getJsonFromParam: function (req, paramName, required, error) {
    ...
    try {
      ...
      pcsapi.log.error(
        'UtilsParamService.getJsonFromParam',
  ...
  getArrayFromParam: getArrayFromParam
}
...
/**
  ...
  */
function getArrayFromParam (req, paramName, required, error) {
  let param = getParam(req, paramName)
...
/**
  ...
  */
function getNumberFromParam (req, paramName, parseFn, required, error) {
  let param = getParam(req, paramName)
...
/**
  ...
  * @return {Date|null} The date or null if invalid
  */
function getDateParam (req, paramName) {
...
/**
  ...
  *
  */
function errorHandling (required, error = 'API_MISSING_PARAM') {
  if (required === true) {
