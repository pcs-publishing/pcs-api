...
module.exports = {
  ...
  startOfDay: function (date, timeZoneName) {
    return this.convertDateToTimezoneMoment(date, timeZoneName).startOf('day').toDate()
  },
  ...
  endOfDay: function (date, timeZoneName) {
    return this.convertDateToTimezoneMoment(date, timeZoneName).endOf('day').toDate()
  },
  ...
  addMonths: function (date, months, timeZoneName) {
    return this.addTimeInterval(date, TIME_INTERVAL.MONTHS, months, timeZoneName)
  },
  ...
  addMinutes: function (date, minutes, timeZoneName) {
    return this.addTimeInterval(date, TIME_INTERVAL.MINUTES, minutes, timeZoneName)
  },
  ...
  addSeconds: function (date, seconds, timeZoneName) {
    return this.addTimeInterval(date, TIME_INTERVAL.SECONDS, seconds, timeZoneName)
  },
  ...
  addMilliSeconds: function (date, milliseconds, timeZoneName) {
    return this.addTimeInterval(date, TIME_INTERVAL.MILLISECONDS, milliseconds, timeZoneName)
  },
  ...
  addTimeInterval: function (date, interval, amount, timeZoneName) {
    return this.convertDateToTimezoneMoment(date, timeZoneName).add(amount, interval).toDate()
  },
  ...
  /**
    ...
    */
  dayOfWeek: function (date, timeZoneName) {
    return this.convertDateToTimezoneMoment(date, timeZoneName).day()
  },
