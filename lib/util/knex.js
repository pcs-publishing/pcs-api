...
module.exports = {
  ...
  selectUserName: function (query, userAttribute, alias = 'user_name') {
    if (!isQueryAlreadyJoinedWithTable(query, 'user')) {
  ...
  filterQueryToActiveOnly: function (query, { tableName, startDate = datetimeUtil.getServerDateTime(), endDate = datetimeUtil.getServerDateTime(), activationAttribute = 'activation_date', expiryAttribute = 'expiry_date' } = {}) {
    return filterToExcludeExpired(query, { tableName, date: startDate, expiryAttribute })
      .where(function () {
  ...
  filterQueryToExpiredOnly: function (query, { tableName, date = datetimeUtil.getServerDateTime(), activationAttribute = 'activation_date', expiryAttribute = 'expiry_date' } = {}) {
    query = checkIfQueryExists(query, tableName)
  ...
  filterToExcludeExpired: filterToExcludeExpired,

  checkIfQueryExists: checkIfQueryExists,

  isQueryAlreadyJoinedWithTable: isQueryAlreadyJoinedWithTable
}
...
/**
  ...
  */
function filterToExcludeExpired (query, { tableName, date = datetimeUtil.getServerDateTime(), expiryAttribute = 'expiry_date' } = {}) {
...
/**
  ...
  */
function checkIfQueryExists (query, tableName) {
...
/**
  ...
  */
function isQueryAlreadyJoinedWithTable (query, tableName) {
